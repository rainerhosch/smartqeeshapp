...
class Fire_Investigation extends CI_Controller
{
    ...
    public function getDataRecord()
    {
        if ($this->input->is_ajax_request()) {
            ...
            $where = null;
            $datareq = $this->fireinvestigation->get_data($where)->result_array();
    ...
    public function delete_data()
    {
        if ($this->input->is_ajax_request()) {
            $data_post = $this->input->post();
            $where = [
                'int_id_Fireinvestigation' => $data_post['id']
            ];
            $delete = $this->fireinvestigation->delete_data($where);
            if (!$delete) {
                $data = [
                    'status' => false,
                    'code' => 500,
    ...
    public function save_data()
    {
        ...
        $insert = $this->fireinvestigation->insert_data($data_insert);
        ...
        if ($insert) {
            ...
            redirect('ncr_ca/Fire_Investigation');
        } else {
            // error
    ...
    public function DownloadsToWord()
    {
        ...
        $where = [
            'int_id_Fireinvestigation' => $data_param['id']
        ];
        $datareq = $this->fireinvestigation->get_data($where)->row_array();
        ...
        $fire_table = [
            ...
            1 => [
                ...
                'label_2' => 'Machine',
                'data_2' => $datareq['txt_incident_machine'],
            ],
            2 => [
                'label_1' => 'Plant',
        ...
        $textrun->addText('FIRE ACCIDENT INVESTIGATION', $boldFontStyleName);
