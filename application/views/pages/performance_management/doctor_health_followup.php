        ...
        <section class="content">
            <div class="card">
                ...
                <ul class="nav nav-tabs bg-secondary" id="custom-content-above-tab" role="tablist" style="margin-bottom: -1px;">
                    <li class="nav-item">
                        <a class="nav-link bg-secondary active-tab btn active" id="custom-content-above-home-tab" data-toggle="pill" href="#list-of-employee-under-control-by-doctor" role="tab" aria-controls="custom-content-above-home" aria-selected="true">LIST OF EMPLOYEES UNDER CONTROL BY DOCTOR</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link bg-secondary active-tab btn" id="custom-content-above-home-tab" data-toggle="pill" href="#doctor-control-performance" role="tab" aria-controls="custom-content-above-home" aria-selected="true">DOCTOR CONTROL PERFORMANCE</a>
                    </li>
                </ul>
                <!--/.TAB-->
                <!--TAB CONTENT-->
                <div class="tab-content" id="custom-content-above-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="list-of-employee-under-control-by-doctor" role="tabpanel" aria-labelledby="custom-content-above-profile-tab">
