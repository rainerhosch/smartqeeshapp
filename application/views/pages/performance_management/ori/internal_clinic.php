            ...
            <div class="card">
                ...
                <div class="tab-content" id="custom-content-above-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="employee-visit-clinic" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
                        <!-- form -->
                        <form class="form-horizontal" method="post" action="<?php echo base_url().'performance_management/internal_clinic/add_data'; ?>">
                        <!--card body-->
                        <div class="card-body" style="background-color: #77a0e6;">

                            <div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" style="text-align:right">EMPLOYEE NUMBER :</i> </label>
                                    <div class="col-sm-2">
                                        <input type="number" class="form-control" name="employee_number" placeholder="NUMBER">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" name="departement" placeholder="TEXT">
                                    </div>

                                    <label class="col-sm-2 col-form-label" style="text-align:right">AGE :</i> </label>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" name="service_period" placeholder="TEXT">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="date" class="form-control" name="date" placeholder="TEXT">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" style="text-align:right">PARAMEDIC NAME :</i> </label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" name="paramedic_name" placeholder="TEXT">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" style="text-align:right">COMPLAINT :</i> </label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" name="complaint" placeholder="TEXT">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" style="text-align:right">ACTION :</i> </label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" name="action" placeholder="TEXT">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" style="text-align:right">MEDICINE :</i> </label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" name="medicine" placeholder="TEXT">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <button type="submit" class="btn btn-flat btn-danger mt-2 col-sm-2">SAVE</button>
                                </div>
                            </div>
                            ...
                            <div class="card" style="background-color: white;">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered-sm ">
                                        ...
                                        <tbody>
                                            <?php $no = 1; foreach ($intclinic as $intc) : ?>
                                                <tr>
                                                    <th scope="row"><?= $no++ ?></th>
                                                    <td><?= $intc->name ?></td>
                                                    <td><?= $intc->departement ?></td>
                                                    <td><?= $intc->age ?></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?= base_url('performance_management/Internal_clinic/delete/') . $intc->internalclinic_id ?>" onclick="javascript: return confirm('Anda yakin hapus?')" class="btn btn-xs btn-secondary">
                                                            <i class="fas fa-trash-alt"></i>
                                                        </a>
                                                        <a href="<?= base_url('') . $intc->internalclinic_id ?>" class="btn btn-xs btn-primary">
                                                            <i class="fas fa-pen"></i>
                                                        </a>
                                                        <a href="<?= base_url('') . $intc->internalclinic_id ?>" class="btn btn-xs btn-success">
