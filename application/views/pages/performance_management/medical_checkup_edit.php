    ...
    <section class="content">
        <div class="card">
            ...
            <ul class="nav nav-tabs bg-secondary " id="custom-content-above-tab" role="tablist" style="margin-bottom: -1px;">
                <li class="nav-item">
                    <a class="nav-link bg-secondary active-tab btn active" id="custom-content-above-home-tab" href="#">EDIT DATA PERSONAL MCU</a>
                </li>
            </ul>
            <!--/.TAB-->
            <!--TAB CONTENT-->
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'performance_management/Medical_checkup/update'; ?>" enctype="multipart/form-data">
                        ...
                        <div class="card-body" style="background-color: #77a0e6;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <select class="form-control js-example-basic-single" id="mcutype" name="mcu_type" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <select class="form-control js-example-basic-single" multiple="multiple"  id="identified_disease" name="identified_disease[]" required>
