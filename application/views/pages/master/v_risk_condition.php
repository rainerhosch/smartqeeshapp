...
<script>
    $(document).ready(function() {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>master/risk_condition/get_json",
            dataType: "json",
            success: function(response) {
                ...
                $('.btnAdd').on('click', function(){
                    $('.modal-title').text('Add Risk Condition');
                    $('#myModal').modal('show');
                })
                ...
                $('#myForm').on('submit', function(e){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url() ?>master/risk_condition/store",
                ...
                $('body').on('click','.btnDelete', function(){
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?= base_url() ?>master/risk_condition/destroy",
                                data: {
                                    id: id
                                },
                                dataType: "json",
                ...
                $('.inputSearch').on('keyup', function(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url() ?>master/risk_condition/search",
                        dataType: "json",
                        data: {
                            keyword:keyword
                        },
