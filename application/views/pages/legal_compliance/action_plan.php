                    ...
                    <table class="table table-bordered table-head-fixed text-center">
                        <thead>
                          <tr>
                            ...
                            <th style="background-color: #999999;">LEGAL AND REQULATION</th>
                            <th style="background-color: #999999;">CLAUSE</th>
                            <th style="background-color: #999999;">PLAN ACTION</th>
                            <th style="background-color: #999999;">TIME TARGET</th>
                            <th style="background-color: #999999;">PIC</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
