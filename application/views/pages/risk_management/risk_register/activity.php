...
<input type="hidden" name="intIdRiskSourceIdentification" id="intIdRiskSourceIdentification"
    value="<?= $intIdRiskSourceIdentification ?>">
                            ...
                            <div class="col-lg-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="" id="txtNoDocNumber" class="form-control"
                                        value="<?= $dok->txtDocNumber ?>" disabled>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xs-12">
                                <div class="form-group">
                                    <label for="">Plant / Departement</label>
                                    <input type="text" name="" id="txtNamaDepartemen" class="form-control"
                                        value="<?= $dok->txtNamaPlant ." / ". $dok->txtNamaDepartement ?>" disabled>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="" id="txtNamaDepartemen" class="form-control"
                                        value="<?= $dok->txtNamaSection ?>" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="" id="dtmInsertedBy" class="form-control"
                                        value="<?= date('d-m-Y', strtotime($dok->dtmInsertedBy)) ?>" disabled>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xs-12">
                                <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="" id="txtNamaActivityShow" class="form-control"
                                            value="" disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="" id="txtNamaTahapanShow" class="form-control" value=""
                                            disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div id="txtNamaContextShow"
                                            style="background-color: #E9ECEF; padding: 0.375rem 0.75rem; border-radius: 0.25rem; border: 1px solid #ced4da;">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="" id="txtNamaIdentificationShow" class="form-control"
                                            value="" disabled>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 d-flex justify-content-end">
                                <button class="btn btn-info" data-toggle="modal" data-target="#modal-default"
                                    id="tombol_add_activity">Add Activity</button>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-lg-12">
...
<?php $this->load->view('pages/risk_management/risk_register/modal/modal_change_status_implemen'); ?>
