      ...
      <section class="content">
        <div class="card">
          ...
          <ul class="nav nav-tabs bg-secondary" id="custom-content-above-tab" role="tablist" style="margin-bottom: -1px;">
            ...
            <li class="nav-item">
              <a class="nav-link active" id="custom-content-above-home-tab" href="<?=base_url("risk_management/Input_new_risk_register/table_activity")?>" role="tab" aria-controls="custom-content-above-home" aria-selected="true">TABEL DATA ACTIVITY</a>
            </li>
            <li class="nav-item">
