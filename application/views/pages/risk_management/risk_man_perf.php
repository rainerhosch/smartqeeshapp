                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="right" width="5%" bgcolor="#E2F0D9">
                                        <a data-toggle="tooltip" data-placement="top" title="Detail" href="#"
                                            style="color: black;" data-filter="LOW" class="btnUpRisk"><i
                                ...
                                <tr>
                                    ...
                                    <td align="right" width="5%" bgcolor="#DEEBF7">
                                        <a data-toggle="tooltip" data-placement="top" title="Detail" href="#"
                                            style="color: black;" data-filter="MEDIUM" class="btnUpRisk"><i
                                                class="fas fa-eye"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="right" width="5%" bgcolor="#FFF2CC">
                                        <a data-toggle="tooltip" data-placement="top" title="Detail" href="#"
                                            style="color: black;" data-filter="HIGH" class="btnUpRisk"><i
                                                class="fas fa-eye"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="right" width="5%" bgcolor="#FBE5D6">
                                        <a data-toggle="tooltip" data-placement="top" title="Detail" href="#"
                                            style="color: black;" data-filter="EXTREME" class="btnUpRisk"><i
                                                class="fas fa-eye"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    ...
                                    <td align="center" style="padding-left: 0px;" bgcolor="#BFBFBF" width="25.5%">
                                        <strong id="intTotalRisk">loading...</strong>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 py-2" style="background-color: #3b3838;">
                    <h1 style="color: white;">DASHBOARD OF APF PERFORMANCE DEPARTEMENT</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    <td bgcolor="#1EAF9C"><strong>LOW RISK</strong></td>
                                    <td align="center" bgcolor="#E2F0D9" width="20%">
                                        <strong id="intLowRiskDepartemen">70</strong>
                                        <!-- | <i class="fa fa-eye"></i> -->
                                    </td>
                                    <td align="right" width="5%" bgcolor="#E2F0D9">
                                        <a data-toggle="tooltip" data-placement="top" title="Detail"
                                ...
                                <tr>
                                    <td bgcolor="#5B9BD5">MEDIUM RISK</td>
                                    <td align="center" bgcolor="#DEEBF7">
                                        <strong id="intMediumRiskDepartemen">70</strong>
                                    </td>
                                    <td align="right" width="5%" bgcolor="#DEEBF7">
                                        <a data-toggle="tooltip" data-placement="top" title="Detail"
                                            href="<?= base_url(); ?>/dashboard/apf_performance/medium_risk"
                                ...
                                <tr>
                                    <td bgcolor="#FFD966">HIGH RISK</td>
                                    <td align="center" bgcolor="#FFF2CC">
                                        <strong id="intHighRiskDepartemen">70</strong>
                                    </td>
                                    <td align="right" width="5%" bgcolor="#FFF2CC">
                                        <a data-toggle="tooltip" data-placement="top" title="Detail"
                                            href="<?= base_url(); ?>/dashboard/apf_performance/hard_risk"
                                ...
                                <tr>
                                    <td bgcolor="#E04A4A">EXTREME RISK</td>
                                    <td align="center" bgcolor="#FBE5D6">
                                        <strong id="intExtremeRiskDepartemen">70</strong>
                                    </td>
                                    <td align="right" width="5%" bgcolor="#FBE5D6">
                                        <a data-toggle="tooltip" data-placement="top" title="Detail"
                                            href="<?= base_url(); ?>/dashboard/apf_performance/extreme_risk"
                                            style="color: black;"><i class="fas fa-eye"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    <td bgcolor="#7F7F7F"><strong>TOTAL RISK</strong></td>
                                    <td align="center" style="padding-left: 0px;" bgcolor="#BFBFBF" width="25.5%">
                                        <strong id="intTotalRiskDepartemen">100</strong>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
    ...
    <div class="modal fade" id="modalTabelRiskDepartemen">
        <div class="modal-dialog modal-xl" style="width: 100%;">
            <div class="modal-content">
                ...
                <div class="modal-body table-responsive">
                    <table class="table table-bordered table-hover" id="tabelRiskDepartemen">
                        <thead>
                            <tr>
                                <th class="text-center">ACTIVITY</th>
                                <th class="text-center">TAHAPAN PROSES</th>
...
//Create pie or douhnut chart
// You can switch between pie and douhnut using the method below.
var chart_program_departemen = new Chart(donutChartCanvas, {
    type: 'doughnut',
    data: donutData,
    options: donutOptions
})
