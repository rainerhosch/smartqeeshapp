            ...
            <div class="row">
                <div class="col-12">
                    <div class="card bg-white">
                        ...
                        <div class="card-body">
                            <a class="btn btn-sm btn-primary btnAdd mb-2" data-toggle="modal">Add Risk Condition</a>
            ...
            <div class="modal-body">
                ...
                <input type="number" name="id" id="id" hidden>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Nama Risk Condition" required>
                        </div>
                    </div>
                    <div class="form-group row">
...
<script>
    $(document).ready(function() {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>manajemen/risk_condition/get_json",
            dataType: "json",
            success: function(response) {
                ...
                $('.btnAdd').on('click', function(){
                    $('.modal-title').text('Tambah Risk Condition');
                    $('#myModal').modal('show');
                })
                ...
                $('body').on('click','.btnEdit', function(){
                    ...
                    $('.modal-title').text('Edit Risk Condition');
                    $('#id').val(id);
                    $('#name').val(name);
                ...
                $('#myForm').on('submit', function(e){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url() ?>manajemen/risk_condition/store",
                ...
                $('body').on('click','.btnDelete', function(){
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "<?= base_url() ?>manajemen/risk_condition/destroy",
                                data: {
                                    id: id
                                },
                                dataType: "json",
                ...
                $('.inputSearch').on('keyup', function(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url() ?>manajemen/risk_condition/search",
                        dataType: "json",
                        data: {
                            keyword:keyword
                        },
