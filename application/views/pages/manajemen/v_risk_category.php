...
<script>
    $(document).ready(function() {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>manajemen/risk_category/get_json",
            dataType: "json",
            success: function(response) {
                ...
                $('.btnAdd').on('click', function(){
                    $('.modal-title').text('Tambah Risk Category');
                    $('#myModal').modal('show');
                })
                ...
                $('#myForm').on('submit', function(e){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url() ?>manajemen/risk_category/store",
                ...
                $('body').on('click','.btnDelete', function(){
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "<?= base_url() ?>manajemen/risk_category/destroy",
                                data: {
                                    id: id
                                },
                                dataType: "json",
                ...
                $('.inputSearch').on('keyup', function(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url() ?>manajemen/risk_category/search",
                        dataType: "json",
                        data: {
                            keyword:keyword
                        },
