		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="form_add_user" enctype="multipart/form-data">
					...
					<div class="form-group row">
						<label for="divisi_user" class="col-sm-2 col-form-label">Plant</label>
						<div class="col-sm-10">
							<select name="" id="id_plant" class="form-control">
								<option value="">Silahkan Pilih Plant</option>
								<?php foreach ($plant as $data) : ?>
									<option value="<?= $data["intIdPlant"] ?>"><?= $data["txtNamaPlant"] ?></option>
								<?php endforeach; ?>
							</select>
						</div>
					</div>
	...
	$(document).ready(function() {
		...
		$("#id_plant").on("change", function() {
			...
			if (id_plant != "") {
				...
				$("#id_departemen").html(`<option value="">Silahkan Pilih Departement</option>`);
			}
