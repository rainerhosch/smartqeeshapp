...
<script>
    $(document).ready(function() {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>roleuser/get_data_role",
            dataType: "json",
            success: function(response) {
                ...
                $("#form_menu_access").submit(function(e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "roleuser/simpan_menu_access",
                ...
                $('.btn_delete_role').on('click', function(){
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "roleuser/delete_role_user", // where you wanna post
                                data: {
                                    id: id
                                },
                                dataType: "json",
                ...
                $('.btn_delete_uam').on('click', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "roleuser/delete_role_access_menu", // where you wanna post
                                data: {
                                    id: id
                                },
                                dataType: "json",
