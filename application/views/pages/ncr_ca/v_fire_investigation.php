    ...
    <section class="content">
        ...
        <div class="card">
            <ul class="nav nav-tabs bg-secondary" id="custom-content-above-tab" role="tablist" style="margin-bottom: -1px;">
                <li class="nav-item">
                    <a class="nav-link bg-secondary " id="custom-content-above-home-tab" data-toggle="pill" href="#activity-list" role="tab" aria-controls="custom-content-above-home" aria-selected="true">INVESTIGATION FORM</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content" id="custom-content-above-tabContent">
                <div class="tab-pane fade" id="activity-list" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
                    <form class="form-horizontal" id="formInvestigationFire" method="post" action="<?= base_url() ?>ncr_ca/Fire_Investigation/save_data" enctype="multipart/form-data">
                        <div class="card-body" style="background-color: #ff000054;">
                            <div class="row">
                                ...
                                <label for="inputIncidentMachine" class="col-sm-2 col-form-label" style="text-align:right">MACHINE:</i> </label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control form-control-sm" id="inputIncidentMachine" name="inputIncidentMachine" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding:0px">
                                    <div class="short-div"><label for="inputFireLevel" class="col-form-label" style="text-align:right">FIRE LEVEL :</label></div>
                                    <div class="short-div"><label for="inputSeverityLevel" class="col-form-label" style="text-align:right">SEVERITY LEVEL :</label></div>
                                    ...
                                    <div class="short-div"><label for="inputFireFacilityUsed" class="col-form-label" style="text-align:right">FIRE FACILITY USED :</label></div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding:0px">
                                    <div class="short-div">
                                        <select class="form-control form-control-sm" id="inputFireLevel" name="inputFireLevel">
                                    ...
                                    <div class="short-div">
                                        <select class="form-control form-control-sm" id="inputSeverityLevel" name="inputSeverityLevel" placeholder="TEXT">
                                            <option value="" disabled selected hidden style="font-size: inherit;">Nothing selected</option>
                                    ...
                                    <div class="short-div">
                                        <select class="form-control form-control-sm" id="inputReccurentProability" name="inputReccurentProability" required>
                                            <option value="" disabled selected hidden style="font-size: inherit;">Nothing selected</option>
                                    ...
                                    <div class="short-div">
                                        <select class="form-control form-control-sm" id="inputFireFacilityUsed" name="inputFireFacilityUsed">
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><textarea class="form-control" id="inputActionTaken" name="inputActionTaken" rows="2"></textarea></div>
                            </div>
