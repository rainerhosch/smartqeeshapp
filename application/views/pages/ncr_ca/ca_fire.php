      ...
      <div class="card card-primary">
        <div class="card-header p-0 border-bottom-0">
          ...
          <ul class="nav nav-tabs bg-secondary" id="corrective-action" role="tablist" style="margin-bottom: -1px;">
            ...
            <li class="nav-item">
              <a class="nav-link bg-secondary active-tab btn btn-flat active" id="ca-fire-tab" href="<?=base_url('ncr_ca/ca_fire')?>" role="tab" aria-controls="ca-fire-tab" aria-selected="true">FIRE INVESTIGATION</a>
            </li>
            <li class="nav-item">
