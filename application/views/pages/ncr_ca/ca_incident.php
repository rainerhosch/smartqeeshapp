    ...
    <div class="card card-secondary">
      <div class="card-header p-0 border-bottom-0">
        ...
        <ul class="nav nav-tabs bg-secondary" id="corrective-action" role="tablist" style="margin-bottom: -1px;">
          <li class="nav-item">
            <a class="nav-link bg-secondary active-tab btn btn-flat active" id="ca-incident-tab"
              href="<?= base_url('ncr_ca/corrective_action/incident_investigation') ?>" role="tab"
              aria-controls="ca-incident-tab" aria-selected="true">INCIDENT INVESTIGATION</a>
          </li>
          <li class="nav-item">
            <a class="nav-link bg-secondary" id="ca-fire-tab"
              href="<?= base_url('ncr_ca/corrective_action/fire_investigation') ?>" role="tab"
              aria-controls="ca-fire-tab" aria-selected="false">FIRE INVESTIGATION</a>
          </li>
          <li class="nav-item">
