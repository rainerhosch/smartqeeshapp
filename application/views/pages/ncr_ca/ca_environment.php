      ...
      <div class="card card-primary">
        <div class="card-header p-0 border-bottom-0">
          ...
          <ul class="nav nav-tabs bg-secondary" id="corrective-action" role="tablist" style="margin-bottom: -1px;">
            <li class="nav-item">
              <a class="nav-link bg-secondary" id="ca-incident-tab" href="<?=base_url('ncr_ca/ca_incident')?>" role="tab" aria-controls="ca-incident-tab" aria-selected="false">INCIDENT INVESTIGATION</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link bg-secondary active-tab btn btn-flat active" id="ca-environment-tab" href="<?=base_url('ncr_ca/ca_environment')?>" role="tab" aria-controls="ca-environment-tab" aria-selected="true">ENVIRONMENT ABNORMALITY</a>
            </li>
          </ul>
          <!-- /.TAB -->
        </div>
        <div class="card-body" style="background-color: #7fc9bf;">
          <div class="tab-content" id="corrective-action-tabContent">
            <div class="tab-pane fade show active" id="ca-environment-tab" role="tabpanel" aria-labelledby="ca-environment-tab">
              ...
              <div class="table-responsive" style="height: 300px;">
                  <table class="table table-bordered table-head-fixed text-center" style="background-color: #dddd;">
                      <thead>
                        <tr>
