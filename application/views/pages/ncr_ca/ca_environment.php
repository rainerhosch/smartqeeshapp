    ...
    <div class="card card-primary">
      <div class="card-header p-0 border-bottom-0">
        ...
        <ul class="nav nav-tabs bg-secondary" id="corrective-action" role="tablist" style="margin-bottom: -1px;">
          ...
          <li class="nav-item">
            <a class="nav-link bg-secondary active-tab btn btn-flat active" id="ca-environment-tab"
              href="<?= base_url('ncr_ca/corrective_action/env_abnormality') ?>" role="tab"
              aria-controls="ca-environment-tab" aria-selected="true">ENVIRONMENT ABNORMALITY</a>
          </li>
        </ul>
        <!-- /.TAB -->
      </div>
