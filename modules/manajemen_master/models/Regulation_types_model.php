...
class Regulation_types_model extends MY_Model
{
    use MY_Tables;

    public function __construct()
	{
		$this->_tabel = $this->_table_regulation_types;
        $this->_crudName = 'Regulation Type';
		parent::__construct();
	}
    ...
    private function _validate()
    {
        ...
        $this->form_validation->set_rules('name', 'Regulation Type Name', $name);
