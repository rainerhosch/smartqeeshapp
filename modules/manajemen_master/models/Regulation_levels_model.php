...
class Regulation_levels_model extends MY_Model
{
    use MY_Tables;

    public function __construct()
	{
		$this->_tabel = $this->_table_regulation_levels;
        $this->_crudName = 'Regulation Levels';
		parent::__construct();
	}
    ...
    private function _validate()
    {
        ...
        $this->form_validation->set_rules('name', 'Regulation Level Name', $name);
